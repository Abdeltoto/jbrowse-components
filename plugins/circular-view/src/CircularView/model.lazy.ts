...
export type CircularViewModel = Instance<ReturnType<typeof enhance>>

export function enhance(base: CircularViewBaseModel) {
  return base
    .volatile(() => ({
